class PokeBattle_Battle
  ...
  def pbCommandPhase
    ...
    @battleAI.pbCynthiaCommandPhase   # AI chooses their actions
  end
    ...
    loop do
      ...
      loop do
        ...
        when 0    # Fight
          ...
          if @battlers[idxBattler].hasActiveAbility?(:WONDERGUARD) && @battlers[idxBattler].hasActiveAbility?([:STURDY, :SHELLARMORPLUS, :FEAR, :STOPRIGHTTHERE])
        ...
        when 1    # Bag
          ...
          battler = @battlers[idxBattler]
          if battler.hasActiveAbility?(:WONDERGUARD) && battler.hasActiveAbility?([:STURDY, :SHELLARMORPLUS, :FEAR, :STOPRIGHTTHERE])
            battler.hp = 0
