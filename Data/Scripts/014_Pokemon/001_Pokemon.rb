...
class Pokemon
  ...
  def calc_stats(hpbars=1)
    ...
    @extraabilities.push(:FLAMEDEBRIS) if hasItem?(:TOXBOOTS)
    @extraabilities.push(:FROSTDEBRIS) if hasItem?(:TOXBOOTS)
    @extraabilities.push(:CHARGEDDEBRIS) if hasItem?(:TOXBOOTS)
