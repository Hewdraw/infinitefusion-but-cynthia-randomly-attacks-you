...
ItemHandlers::UseOnPokemon.add(:OMNIDRIVE, proc { |item, pkmn, scene|
  upgradelist = {
    ...
    [:CUBONE, :MAROWAK, :ALOLACUBONE, :ALOLAMAROWAK] => [[:BONEMERANG]],
    [:IGGLYBUFF, :JIGGLYPUFF, :WIGGLYTUFF, :SCREAMTAIL] => [[:BOOMBURST]],
    [:ENTEI, :GOUGINGFIRE, :ENRAICUNE, :MAIMINGSOUL] => [[:BURNINGBULWARK]],
    [:TYNAMO, :EELEKTRICK, :EELEKTROSS] => [[:CHARGEBEAM]],
    [:JANGMOO, :HAKAMOO, :KOMMOO] => [[:CLANGINGSCALES]],
    [:CHIMCHAR, :MONFERNO, :INFERNAPE, :TRIPLE_SINNOH1, :TRIPLE_SINNOH2, :TORTERNEON] => [[:CLOSECOMBAT]],
    [:PORYGON, :PORYGON2, :PORYGONZ] => [[:CONVERSION3]],
    [:LARVITAR, :PUPITAR, :TYRANITAR, :IRONTHORNS] => [[:CRUNCH], [:STONEEDGE]],
    [:REGIGIGAS] => [[:CRUSHGRIP]],
    [:DEINO, :ZWEILOUS, :HYDREIGON, :IRONJUGULIS] => [[:DARKPULSE], [:DRACOMETEOR]],
    [:GIBLE, :GABITE, :GARCHOMP] => [[:DRAGONCLAW]],
    [:TURTWIG, :GROTLE, :TORTERRA, :TRIPLE_SINNOH1, :TRIPLE_SINNOH2, :TORTERNEON] => [[:EARTHQUAKE]],
    [:KOFFING, :WEEZING, :GALARWEEZING, :CREEPER, :GRIMER, :MUK, :ALOLAGRIMER, :ALOLAMUK, :SNORUNT, :GLALIE, :FROSLASS] => [[:EXPLOSION]],
    [:DRATINI, :DRAGONAIR, :DRAGONITE] => [[:EXTREMESPEED]],
    [:LARVESTA, :VOLCARONA, :SLITHERWING, :IRONMOTH] => [[:FIERYDANCE, :TORCHSONG]],
    [:MOLTRES, :GALARMOLTRES, :ZAPMOLTICUNO, :GALARZAPMOLTICUNO] => [[:FIERYWRATH]],
    [:WIMPOD, :GOLISOPOD, :LARVESTA, :VOLCARONA, :SLITHERWING, :IRONMOTH] => [[:FIRSTIMPRESSION, :MAXXSPEED]],
    [:PIPLUP, :PRINPLUP, :EMPOLEON, :TRIPLE_SINNOH1, :TRIPLE_SINNOH2, :TORTERNEON] => [[:FLASHCANNON]],
    [:DIANCIE, :MAGEARNA] => [[:DIAMONDSTORM], [:FLEURCANNON]],
    [:ARTICUNO, :GALARARTICUNO, :ZAPMOLTICUNO, :GALARZAPMOLTICUNO] => [[:FREEZINGGLARE]],
    [:BULBASAUR, :IVYSAUR, :VENUSAUR, :PALMON, :TOGEMON, :LILLYMON, :ROSEMON, :ROSEMONBM, :TRIPLE_KANTO1, :TRIPLE_KANTO2, :VENUSTOIZARD] => [[:FRENZYPLANT]],
    [pkmn.species, pkmn.materials].flatten => [[:HIDDENPOWER, :TERABLAST], [:FOCUSBLAST]],
    [:CELEBI, :CELEMEWCHI] => [[:FUTURESIGHT], [:SEEDFLARE]],
    ...
    [:SUICUNE, :WALKINGWAKE, :ENRAICUNE, :MAIMINGSOUL] => [[:HYDROSTEAM]],
    [:MELOETTA_A, :MELOETTA_P, :VOCALLEEK, :VOCALDRILL, :VOCALCELL] => [[:HYPNOSIS, :MESMERIZER]],
    [:REGICE, :ARTICUNO, :GALARARTICUNO, :ZAPMOLTICUNO, :GALARZAPMOLTICUNO] => [[:ICEBEAM]],
    [:REGISTEEL, :MAWILE, :SHROOMAWGROSS] => [[:IRONHEAD]],
    [:BAGON, :SHELGON, :SALAMENCE, :ROARINGMOON] => [[:JAWLOCK]],
    [:PAWNIARD, :BISHARP, :KINGAMBIT] => [[:KOWTOWCLEAVE]],
    [:TREEKO, :GROVYLE, :SCEPTILE, :TRIPLE_HOENN1, :TRIPLE_HOENN2, :SWAMPTILIKEN] => [[:LEAFBLADE]],
    [:LATIOS] => [[:LUSTERPURGE]],
    [:MAGNEMITE, :MAGNETON, :MAGNEZONE, :SANDYSHOCKS, :NOSEPASS, :PROBOPASS] => [[:MAGNETBOMB]],
    [:HERACROSS] => [[:MEGAHORN]],
    [:BELDUM, :METANG, :METAGROSS, :SHROOMAWGROSS] => [[:METEORMASH]],
    [:LATIAS] => [[:MISTBALL]],
    [:MUDKIP, :MARSHTOMP ,:SWAMPERT, :TRIPLE_HOENN1, :TRIPLE_HOENN2, :SWAMPTILIKEN] => [[:MUDDYWATER]],
    [:MISDREAVUS, :MISMAGIUS, :FLUTTERMANE, :FENNEKIN, :BRAIXEN, :DELPHOX, :TRIPLE_KALOS1, :TRIPLE_KALOS2, :TRIPLE_KALOS3] => [[:MYSTICALFIRE]],
    [:REMORAID, :OCTILLERY] => [[:OCTAZOOKA]],
    [:MAWILE, :SHROOMAWGROSS] => [[:PLAYROUGH]],
    [:MEW, :CELEMEWCHI] => [[:PSYCHIC], [:GENESISSUPERNOVA]],
    [:RALTS, :KIRLIA, :GARDEVOIR, :GALLADE, :IRONVALIANT] => [[:PSYSHOCK]],
    [:PHANPY, :DONPHAN, :GREATTUSK, :IRONTREADS] => [[:RAPIDSPIN]],
    [:RHYHORN, :RHYDON, :RHYPERIOR] => [[:ROCKWRECKER]],
    [:HOOH, :ENTEI, :GOUGINGFIRE, :ENRAICUNE, :MAIMINGSOUL] => [[:SACREDFIRE]],
    [:CHESPIN, :QUILLADIN, :CHESNAUGHT, :TRIPLE_KALOS1, :TRIPLE_KALOS2, :TRIPLE_KALOS3, :CACNEA, :CACTURNE] => [[:SPIKYSHIELD]],
    [:MAGIKARP, :GYARADOS] => [[:SPLASH]],
    [:REGIROCK] => [[:STONEEDGE]],
    [:GENESECT] => [[:TECHNOBLAST]],
    [:KABUTO, :KABUTOPS, :REAPINGSHELL] => [[:TECHNOBLAST, :HYDROBURST]],
    [:UNOWN] => [[:TERABLAST, :TERASTARSTORM]],
    [:RAIKOU, :RAGINGBOLT, :ENRAICUNE, :MAIMINGSOUL] => [[:THUNDERCLAP]],
    [:ZAPDOS, :GALARZAPDOS, :ZAPMOLTICUNO, :GALARZAPMOLTICUNO] => [[:THUNDEROUSKICK]],
    [:DODUO, :DODRIO, :DIGLET, :DUGTRIO, :ALOLADIGLETT, :ALOLADUGTRIO, :DEINO, :ZWEILOUS, :HYDREIGON, :PORYGON, :PORYGON2, :PORYGONZ, :ZAPMOLTICUN, :GALARZAPMOLTICUNO, :ENRAICUNE, :MAIMINGSOUL, :ZEKYUSHIRAM, :REGITRIO, :WITHER] => [[:TRIATTACK]],
    [:WEEDLE, :KAKUNA, :BEEDRILL, :VESPIQUEN] => [[:TWINEEDLE]],
    [:FROAKIE, :FROGADIER,:GRENINJA, :TRIPLE_KALOS1, :TRIPLE_KALOS2, :TRIPLE_KALOS3] => [[:WATERSHURIKEN]],
  }
  allmoves = pkmn.isFusionOf(:GENESECT) || pkmn.species == :DEOSECTWO
  upgradelist.each do |pokemon, movearray|
    pokemon.each do |mon|
      next unless allmoves || pkmn.isFusionOf(mon)
  ...
  if (pokemon.foreign?($Trainer)) # && !canunfuse
    ...
    if Kernel.pbConfirmMessageSerious(_INTL("Should {1} be unfused?", pokemon.name))
      ...
      if $Trainer.party.length >= 6 && !pcPosition
        ...
        choice = Kernel.pbMessage("Select a Pokémon to keep in your party.", ["#{PBSpecies.getName(bodyPoke)}", "#{PBSpecies.getName(headPoke)}", _INTL("Cancel")], 2)
        if choice == 2
          return false
        else
          keepInParty = choice
...
ItemHandlers::UseFromBag.add(:MILLENNIUMANKH, proc { |item|
  ...
  delay = (Graphics.frame_rate*16*0.94).to_i
  viewport = Viewport.new(0,0,Graphics.width,Graphics.height)
  viewport.z = 99999
