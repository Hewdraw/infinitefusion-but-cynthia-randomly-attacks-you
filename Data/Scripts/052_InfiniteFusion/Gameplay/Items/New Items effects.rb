...
ItemHandlers::UseOnPokemon.add(:OMNIDRIVE, proc { |item, pkmn, scene|
  upgradelist = {
    ...
    [:ENTEI, :GOUGINGFIRE, :ENRAICUNE] => [[:BURNINGBULWARK]],
    ...
    [:MOLTRES, :GALARMOLTRES, :ZAPMOLTICUNO] => [[:FIERYWRATH]],
    ...
    [:ARTICUNO, :GALARARTICUNO, :ZAPMOLTICUNO] => [[:FREEZINGGLARE]],
    ...
    [:SUICUNE, :WALKINGWAKE, :ENRAICUNE] => [[:HYDROSTEAM]],
    [:MELOETTA_A, :MELOETTA_P, :VOCALLEEK, :VOCALDRILL, :VOCALCELL] => [[:HYPNOSIS, :MESMERIZER]],
    [:REGICE, :ARTICUNO, :GALARARTICUNO, :ZAPMOLTICUNO] => [[:ICEBEAM]],
    ...
    [:HERACROSS] => [[:MEGAHORN]],
    [:BELDUM, :METANG, :METAGROSS] => [[:METEORMASH]],
    [:LATIAS] => [[:MISTBALL]],
    ...
    [:HOOH, :ENTEI, :GOUGINGFIRE, :ENRAICUNE] => [[:SACREDFIRE]],
    ...
    [:RAIKOU, :RAGINGBOLT, :ENRAICUNE] => [[:THUNDERCLAP]],
    [:ZAPDOS, :GALARZAPDOS, :ZAPMOLTICUNO] => [[:THUNDEROUSKICK]],
    [:DODUO, :DODRIO, :DIGLET, :DUGTRIO, :ALOLADIGLETT, :ALOLADUGTRIO, :DEINO, :ZWEILOUS, :HYDREIGON, :PORYGON, :PORYGON2, :PORYGONZ, :ZAPMOLTICUNO, :ENRAICUNE, :ZEKYUSHIRAM, :REGITRIO, :WITHER] => [[:TRIATTACK]],
