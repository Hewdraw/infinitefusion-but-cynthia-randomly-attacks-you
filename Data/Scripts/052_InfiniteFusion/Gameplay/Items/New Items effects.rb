...
ItemHandlers::UseOnPokemon.add(:OMNIDRIVE, proc { |item, pkmn, scene|
  upgradelist = {
    ...
    [:CHIMCHAR, :MONFERNO, :INFERNAPE] => [[:CLOSECOMBAT]],
    ...
    [:TURTWIG, :GROTLE, :TORTERRA] => [[:EARTHQUAKE]],
    ...
    [:MISDREAVUS, :MISMAGIUS, :FLUTTERMANE, :FENNEKIN, :BRAIXEN, :DELPHOX] => [[:MYSTICALFIRE]],
    [:REMORAID, :OCTILLERY] => [[:OCTAZOOKA]],
    [:MAWILE] => [[:PLAYROUGH], [:IRONHEAD]],
    [:MEW] => [[:PSYCHIC], [:GENESISSUPERNOVA]],
    ...
    [:CHESPIN, :QUILLADIN, :CHESNAUGHT, :CACNEA, :CACTURNE] => [[:SPIKYSHIELD]],
    ...
    [:FROAKIE, :FROGADIER,:GRENINJA] => [[:WATERSHURIKEN]],
  }
