...
ItemHandlers::UseOnPokemon.add(:OMNIDRIVE, proc { |item, pkmn, scene|
  upgradelist = {
    ...
    [:PAWNIARD, :BISHARP] => [[:KOWTOWCLEAVE]],
    [:SQUIRTLE, :WARTORTLE, :BLASTOISE, :TRIPLE_KANTO1, :TRIPLE_KANTO2, :VENUSTOIZARD] => [[:HYDROCANNON]],
    [:TORCHIC, :COMBUSKEN, :BLAZIKEN, :TRIPLE_HOENN1, :TRIPLE_HOENN2, :SWAMPTILIKEN] => [[:BLAZEKICK]],
    [:CHARMANDER, :CHARMELEON, :CHARIZARD, :TRIPLE_KANTO1, :TRIPLE_KANTO2, :VENUSTOIZARD] => [[:BLASTBURN]],
    ...
    [:DODUO, :DODRIO, :DIGLET, :DUGTRIO, :DEINO, :ZWEILOUS, :HYDREIGON, :PORYGON, :PORYGON2, :PORYGONZ, :ZAPMOLTICUNO, :ENRAICUNE, :ZEKYUSHIRAM, :REGITRIO, :WITHER] => [[:TRIATTACK]],
    ...
    [:BULBASAUR, :IVYSAUR, :VENUSAUR] => [[:FRENZYPLANT]],
