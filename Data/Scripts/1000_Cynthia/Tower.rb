...
def getTowerPokemon(filter=nil)
    ...
    legallist.push(:GREATTUSK, :SCREAMTAIL, :FLUTTERMANE, :SLITHERWING, :SANDYSHOCKS, :ROARINGMOON, :IRONTREADS, :IRONBUNDLE, :IRONJUGULIS, :IRONMOTH, :IRONTHORNS, :IRONVALIANT, :IRONHARVESTER, :IRONHANDS) if $PokemonGlobal.towervalues[:floor] >= 50
...
def towerEvent()
    ...
    when "Legendary"
        ...
        when "Ho-Gia"
            $PokemonGlobal.nextBattleBGM = "VSLugia"
        when "Latias"
