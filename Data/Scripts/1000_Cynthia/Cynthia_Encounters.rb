  ...
  if !encounter_type
    ...
    if first_pkmn
      ...
      when :PUREINCENSE
        ...
        when :STENCH, :WHITESMOKE, :QUICKFEET, :INTIMIDATE, :MENACE, :KEENEYE, :FEAR, :BIGPECKSPLUS
          chanceincrease *= 2
        when :SANDVEIL
    ...
    if rand(maxcynthiachance) < $PokemonGlobal.cynthiachance || (isRepelActive() && !$PokemonTemp.pokeradar)
