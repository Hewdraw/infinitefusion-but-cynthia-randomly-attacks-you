EMERADICT = {
    ...
    #     :description => "Your Pokemon immediately use charging moves that have no charging effect. Your Pokemon take 1 less turn to use Future Sight, Doom Desire, or Perish Song.",
    #     :rarity => :LEGENDARY,
    #     :legendary => [:CELEBI],
    ...
    #     :description => "Your Pokemons Wish also heals at the end of the turn.",
    #     :rarity => :LEGENDARY,
    #     :legendary => [:JIRACHI],
    #     :tutormove => :DOOMDESIRE,
    ...
    #     :tutormove => :VCREATE,
    #     :tutorcondition => -> (pokemon) {return pokemon.hasType?(:DRAGON) || pokemon.hasType?(:FLYING)},
    # },
    # :RUSTEDSHIELD => {
    #     :name => "Rusted Shield",
