EMERADICT = {
    ...
    :TRAININGGEAR => {
        :name => "Training Gear",
        :description => "Your Pokemon evolve 5 levels earlier. Gain 3 Evolution Stones at the start.",
        :rarity => :STARTER,
    },
    :CATCHINGNET => {
        :name => "Catching Net",
    ...
    :INDIEPROOF => {
        :name => "Indie Proof",
        :description => "You can only use 1 Pokemon. Its stats are doubled. It gains the Sturdy Ability.",
        :rarity => :STARTER,
    },
    :DIAMONDPICKAXE => {
    ...
    :NEWSHOES => {
        :name => "New Shoes",
        :description => "Your Pokemon with Run Away are unaffected by hazards and their moves that switch them out gain 1 priority.",
        :rarity => :COMMON,
    },
    :NOTEBLOCK => {
        :name => "Noteblock",
    ...
    # :WINDYKNIFE => {
    #     :name => "Windy Knife",
    #     :description => "Your Pokemons Razor Wind is now a 40 Base Power Multistrike move.",
    #     :rarity => :COMMON,
    # },
    # :WORM => {
    #     :name => "Worm",
    #     :description => "Your Pokemons Rage and Bide will also Taunt opposing Pokemon.",
    #     :rarity => :COMMON,
    # },
    ...
    # :MACE => {
    #     :name => "Mace",
    #     :description => "Switching out will make the next attack do 1.3x damage.",
    #     :rarity => :RARE,
    # },
    # :SECONDGLOVE => {
    #     :name => "Second Glove",
    ...
    :COSMICFLUTE => {
        :name => "Cosmic Flute",
        :description => "Your Pokemon gain 1.1x Defense and Special Defense and their weight is doubled.",
        :rarity => :LEGENDARY,
        :tutormove => :COSMICPOWER,
        :tutorcondition => -> (pokemon) {return pokemon.hasType?(:PSYCHIC)},
    },
    :DISCOVERYSLATE => {
    ...
    #     :tutormove => :TRIATTACKPLUS,
    #     :tutorcondition => -> (pokemon) {return pokemon.hasType?(:ICE) || pkmn.hasType?(:FIRE) || pkmn.hasType?(:ELECTRIC)},
    # },
    :ENIGMASTONE => {
        :name => "Enigma Stone",
        ...
        :tutorcondition => -> (pokemon) {return pokemon.hasType?(:PSYCHIC) || pokemon.hasType?(:DRAGON)},
    },
    # :GOLDSILVERBALL => {
    ...
    :RUSTEDSHIELD => {
        :name => "Rusted Shield",
        :description => "Your Pokemon gain 1.2x Defense.",
        :rarity => :LEGENDARY,
        :tutormove => :BEHEMOTHBASH,
        :tutorcondition => -> (pokemon) {return pokemon.hasType?(:STEEL)},
    },
    :RUSTEDSWORD => {
        :name => "Rusted Sword",
        :description => "Your Pokemon gain 1.2x Attack.",
        :rarity => :LEGENDARY,
        :tutormove => :BEHEMOTHBLADE,
        :tutorcondition => -> (pokemon) {return pokemon.hasType?(:STEEL)},
    },
    # :SCARLETBOOK => {
    #     :name => "Scarlet Book",
    ...
    # :SHADOWCRYSTAL => {
    #     :name => "Shadow Crystal",
    #     :description => "Opposing Pokemon take 1/8th damage while they are drowsy.",
    #     :rarity => :LEGENDARY,
    #     :legendary => [:DARKRAI],
    #     :tutormove => :DARKVOID,
...
def getEmeras
    ...
    raritylist = [:COMMON, :UNCOMMON, :RARE, :LEGENDARY]
