BattleHandlers::AbilityOnBattlerFainting.add(:EMERA,
  proc { |ability,battler,fainted,battle|
    if fainted.hasActiveEmera?(:STUNSEED) && fainted.isFusionOf([:SLUGMA, :GULPIN, :SWELLOW, :RHYDON])
...
def pbFloorEmeras
  if hasEmera?(:BREWINGSTAND)
    itemlist = [:FULLHEAL, :FULLRESTORE, :HYPERPOTION, :MAXELIXIR, :MAXPOTION, :POTION, :SUPERPOTION, :ANTIDOTE, :AWAKENING, :BURNHEAL, :ICEHEAL, :PARLYZHEAL, :ELIXIR, :ETHER, :MAXETHER]
